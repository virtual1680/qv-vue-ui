...
type Permission<T> =
  ...
  | ((key: string, row: T, index: number) => Record<string, boolean>)
...
export default {
  ...
  rowClassName: [String, Function] as PropType<
    CrudProps<DefaultRow>['rowClassName']
  >,
  cellClassName: [String, Function] as PropType<
    CrudProps<DefaultRow>['cellClassName']
  >,
  headerRowClassName: [String, Function] as PropType<
    CrudProps<DefaultRow>['headerRowClassName']
  >,
  headerCellClassName: [String, Function] as PropType<
    CrudProps<DefaultRow>['headerCellClassName']
  >,
