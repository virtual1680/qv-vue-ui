...
const headerSearchRef: Ref<InstanceType<typeof HeaderSearch> | undefined> =
  ref()
...
// * 合集统计逻辑
const tableSummaryMethod = <T = any>(param: {
...
const rowParentKey = computed(() => {
  return DIC_PROPS.rowParentKey //tableOption.value.rowParentKey ||
})
const childrenKey = computed(() => {
  return DIC_PROPS.children //props.treeProps.children ||
})
const hasChildrenKey = computed(() => {
  return DIC_PROPS.hasChildren //props.treeProps.hasChildren ||
})
